CREATE OR REPLACE PACKAGE pkwf_30_cs_new_j AUTHID DEFINER AS
 /** 
  * ===========================================================<br/>
  ...
  */
  ...
  FUNCTION fn_ins(pi_rec IN wf_vi_30_cs_new_j%ROWTYPE) RETURN pkwf_90_gen.r_ret;
  --
  FUNCTION fn_get_j_dc_k(pi_dc_k IN NUMBER) RETURN NUMBER;
  --
  -- Set images as appropriate
  FUNCTION fn_set_img(pi_dc_k IN NUMBER) RETURN pkwf_90_gen.r_ret;
  --
